                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('cliente.update', $cliente->id) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="nome" class="block mt-1 w-full" type="text" name="nome" :value="old('nome', $cliente->nome)" required autofocus autocomplete="nome" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="endereco" class="block mt-1 w-full" type="text" name="endereco" :value="old('endereco', $cliente->endereco)" required autofocus autocomplete="endereco" />
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="cidade" class="block mt-1 w-full" type="text" name="cidade" :value="old('cidade', $cliente->cidade)" required autofocus autocomplete="cidade" />
